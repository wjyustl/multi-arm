...
class Panda(PyBulletRobot):
    ...
    def __init__(
        ...
        self.neutral_joint_values2 = np.array([0.58,-1.83,-0.63,-3.20,-0.62, 1.35, 2.96, 0.00, 0.00])
        self.ee_link = 11
    ...
    def pid_action(self,action:np.ndarray)->None:
        ...
        print("joint angles:",target_arm_angles)
    ...
    def ee_displacement_to_target_arm_angles(self, ee_displacement: np.ndarray) -> np.ndarray:
        ...
        target_ee_position = ee_position + ee_displacement
        # Clip the height target. For some reason, it has a great impact on learning
        target_ee_position = target_ee_position.flatten()
        target_ee_position[2] = np.max((0, target_ee_position[2]))
        # compute the new joint angles
        target_arm_angles = self.inverse_kinematics(
            link=self.ee_link, position=target_ee_position, orientation=np.array([1.0, 0.0, 0.0, 0.0])
    ...
    def reset2(self) -> None:
        self.set_joint_neutral2()

    def set_joint_neutral(self) -> None:
        """Set the robot to its neutral pose."""
        self.set_joint_angles(self.neutral_joint_values)

    def set_joint_neutral2(self) -> None:
        """Set the robot to its neutral pose."""
        self.set_joint_angles(self.neutral_joint_values2)
